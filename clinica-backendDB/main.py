...
# CRUD para Usuarios
@app.post("/create_usuarios/", response_model=schemas.Usuario, tags=["Usuarios"])
...
@app.get("/read_usuarios/", response_model=List[schemas.Usuario], tags=["Usuarios"])
def read_usuarios(db: Session = Depends(get_db)):
    usuarios = crud.get_usuarios(db)
    return usuarios

@app.get("/read_usuarios/{usuario_id}", response_model=schemas.Usuario, tags=["Usuarios"])
...
@app.put("/update_usuarios/{usuario_id}", response_model=schemas.Usuario, tags=["Usuarios"])
...
@app.delete("/delete_usuarios/{usuario_id}", tags=["Usuarios"])
...
@app.post("/create_especialistas/", response_model=schemas.Especialista, tags=["Especialista"])
...
@app.get("/read_especialistas/", response_model=List[schemas.Especialista], tags=["Especialista"])
def read_especialistas(db: Session = Depends(get_db)):
    especialistas = crud.get_especialistas(db)
    return especialistas

@app.get("/read_especialistas/{especialista_id}", response_model=schemas.Especialista, tags=["Especialista"])
...
@app.put("/update_especialista/{especialista_id}", response_model=schemas.Especialista, tags=["Especialista"])
...
@app.delete("/delete_especialista/{especialista_id}", tags=["Especialista"])
...
# CRUD para Citas
@app.post("/create_citas/", response_model=schemas.Cita, tags=["Citas"])
def create_cita(cita: schemas.CitaCreate, db: Session = Depends(get_db)):
    return crud.create_cita(db=db, cita=cita)

@app.get("/read_citas/", response_model=List[schemas.Cita], tags=["Citas"])
...
@app.get("/read_citas/{cita_id}", response_model=schemas.Cita, tags=["Citas"])
...
@app.put("/update_citas/{cita_id}", response_model=schemas.Cita, tags=["Citas"])
...
@app.delete("/delete_citas/{cita_id}", tags=["Citas"])
...
@app.post("/create_procedimientos/", response_model=schemas.Procedimiento, tags=["Procedimiento"])
...
@app.get("/read_procedimientos/", response_model=List[schemas.Procedimiento], tags=["Procedimiento"])
def read_procedimientos(db: Session = Depends(get_db)):
    procedimientos = crud.get_procedimientos(db)
    return procedimientos

@app.get("/read_procedimientos/{procedimiento_id}", response_model=schemas.Procedimiento, tags=["Procedimiento"])
...
@app.put("/update_procedimiento/{procedimiento_id}", response_model=schemas.Procedimiento, tags=["Procedimiento"])
...
@app.delete("/delete_procedimiento/{procedimiento_id}", tags=["Procedimiento"])
...
#endpoints historial
@app.post("/create_historial_clinico/", response_model=schemas.HistorialClinico, tags=["Historial"])
...
@app.get("/read_historiales_clinicos/{usuario_id}", response_model=List[schemas.HistorialClinico], tags=["Historial"])
...
@app.put("/update_historial_clinico/{historial_id}", response_model=schemas.HistorialClinicoUpdate, tags=["Historial"])
...
@app.delete("/delete_historial_clinico/{historial_id}", tags=["Historial"])
